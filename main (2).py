'''Imlement a class called bankaccount that represent a bank account.the class should have private
attributes for account number,account holder name,and account balance.include methods to
deposite money,withdraw money,and display the account balance.enure that the account balance
cannot be accessed directly form outside the class.writeb a program to create an instance of the 
...
account = BankAccount(account_number="123456789",account_holder_name= "Akash",initial_balance=10000)

# Test deposit and withdrawal functionality
account.display_balance()
account.deposit(2000)
account.withdraw(2022)
account.display_balance()
